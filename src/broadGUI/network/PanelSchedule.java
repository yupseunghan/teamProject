...
public class PanelSchedule extends JFrame {
    ...
    public PanelSchedule(JFrame frame, List<TvProgram> comList) {
        setTitle("편성표 조회");
        setSize(400, 300);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setLocationRelativeTo(frame);

        this.tvPrograms = (comList != null) ? comList : List.of(); // Null 방지
    ...
    public PanelSchedule(JFrame frame, ObjectOutputStream oos, ObjectInputStream ois) throws ClassNotFoundException, IOException {
        setTitle("편성표 조회");
        setSize(400, 300);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        setLocationRelativeTo(frame);
        ...
        TvProgram KBS = (TvProgram)ois.readObject();
        TvProgram SBS = (TvProgram)ois.readObject();
        TvProgram MBC = (TvProgram)ois.readObject();
