...
public class FrameMain extends JFrame {
    ...
    private HashMap<String, List<String>> tvProgramMap;            //일단은 이렇게 했는데 나중에는 tv객체로 가져올것
    ...
    private void display() {
        ...
        List<String> programs = tvProgramMap.getOrDefault(channel, new ArrayList<>()); //일단은 이렇게 했는데 db에서 방송사, 요일에 해당하는 tv객체들 가져와서 넣게
        // 요일별 데이터 추가 필요
        ...
        if (programs.isEmpty()) {
        	...
        	broadTimeManager.print(channel,week);
        }
    }
}
